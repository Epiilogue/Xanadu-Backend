...
public class DPCGenerator {

    public static void main(String[] args) {
        //1、配置数据源
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/xanadu_dpc", "root", "xgs1150840779")
                //2、全局配置
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("dpc_dispatch","dpc_task") // 设置需要生成的数据表名
                            .addTablePrefix("dpc_") // 设置过滤表前缀
                            //4.1、Mapper策略配置
                            .mapperBuilder()
